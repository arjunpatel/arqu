...
class DictionariesControllerTest < ActionController::TestCase
  ...
  test "should create dictionary" do
    assert_difference('Dictionary.count') do
      post :create, dictionary: { description: @dictionary.description, voice_id: @dictionary.voice_id, word: @dictionary.word }
    end
  ...
  test "should update dictionary" do
    put :update, id: @dictionary, dictionary: { description: @dictionary.description, voice_id: @dictionary.voice_id, word: @dictionary.word }
    assert_redirected_to dictionary_path(assigns(:dictionary))
  end
